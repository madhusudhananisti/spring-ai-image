...
public class QuestionController {
    ...
    public ResponseEntity<String> upload(@Validated @RequestParam("file") MultipartFile file, @RequestParam("name") String name) {
        String response = openAIService.getDescription(file);
